...
export class WorkflowService {
    ...
    /**
     * [NEW] Handles the request for the GTH (Gmail) quote.
     */
    async handleGmailQuoteRequest() {
        try {
            ...
            // [NEW] Call the GTH-specific generator function
    ...
    _getQuoteDataWithSnapshots() {
        ...
        if (dataWithSnapshot.f1Snapshot) {
            ...
            const remote16chQty = (ui.f1.remote_1ch_qty === null) ? totalRemoteQty - remote1chQty : ui.f1.remote_1ch_qty;
